...
const promiseOne = new Promise(function (resolve, reject) {
  // promise ya to pura hoga nhi to nhi hoga.. pura hua to resolve wrna reject
  // Do an Async Task
...
//   try {
//     const response = await fetch("https://jsonplaceholder.typicode.com/users"); // fetch phle library thi but avi to srf. ek object h
...
// }
// getAllUsers();
// but why the code is still not running?
// coz. response.json v convert hone me tym lgta h to wha v hume await lgana h


// Now we want to write this same function in .then .catch format
// ADVANTAGE of Using this: We don't have to use try() ctach() or wait coz. yha phla .then khtm hoga tvi dusra .then suru hoga 
fetch('https://jsonplaceholder.typicode.com/users')
.then((response) => {
  return response.json()
})
.then((data) => {     // ye .then upar wle response.json() ko handle krne ke liye h
  console.log(data);
})
.catch((error) => {
  console.log(error);
...
// **** NOTE ****
// We observe here that data of Fetch comes first in output even the code is written at the end. But How?
// --> In Next Lecture.